...
echo "      module resmod ! generated by compile.sh ">plasim/bld/resmod.f90
echo "      parameter(NLAT_ATM = "$latitudes") ">>plasim/bld/resmod.f90
echo "      parameter(NLEV_ATM = "$levels") ">>plasim/bld/resmod.f90
echo "      parameter(NPRO_ATM = "$ncpus") ">>plasim/bld/resmod.f90
echo "      end module resmod ">>plasim/bld/resmod.f90
echo " ">>plasim/bld/resmod.f90
...
cd ../../
cp plasim/dat/T"${resolution[@]:1}"/* plasim/run/
